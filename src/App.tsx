...
export default function App() {
    ...
    return (
        <div className="flex min-h-screen flex-col bg-slate-950 font-sans text-slate-100 antialiased selection:bg-purple-500 selection:text-white">
            {/* Navigation Header */}
            {viewMode !== 'HOST' && (
                <Header
            ...
            <main className="flex-1 pt-4 pb-12">
                ...
                {viewMode === 'HOST' && <GameHostView quiz={quizData} onExitHost={() => setViewMode('LOBBY')} />}
