...
export const SAMPLE_QUIZZES: { id: string; name: string; data: QuizData }[] = [
            ...
            questions: [
                {
                    id: 1,
                    question:
                        'Thời lượng pin tối đa của Sony WH-1000XM5 khi bật tính năng chống ồn (ANC) là bao nhiêu?',
                    options: [
                        { id: 'A', text: '30 giờ' },
                        { id: 'B', text: '20 giờ' },
                        { id: 'C', text: '40 giờ' },
                    ...
                    correct_option_id: 'A',
                    explanation:
                        'Sony WH-1000XM5 hỗ trợ phát nhạc liên tục lên đến 30 giờ khi bật tính năng chống ồn ANC và lên đến 40 giờ khi tắt ANC.',
                ...
                },
                {
                    ...
                    correct_option_id: 'C',
                    explanation:
                        'WH-1000XM5 sở hữu hệ thống 8 micro kết hợp với bộ xử lý chống ồn HD QN1 và V1 giúp lọc tiếng ồn vượt trội.',
                ...
                },
                {
                    ...
                    correct_option_id: 'A',
                    explanation:
                        'Tính năng Speak-to-Chat tự động nhận diện giọng nói của bạn, tạm dừng nhạc và mở chế độ xuyên âm để bạn trò chuyện mà không cần tháo tai nghe.',
                ...
                },
                {
                    id: 4,
                    question:
                        'Thời gian sạc nhanh 3 phút bằng củ sạc USB-PD tương thích mang lại bao nhiêu giờ sử dụng?',
                    options: [
                        { id: 'A', text: '1 giờ' },
                        { id: 'B', text: '3 giờ' },
                        { id: 'C', text: '5 giờ' },
                    ...
                    correct_option_id: 'B',
                    explanation:
                        'Chỉ với 3 phút sạc bằng bộ sạc USB Power Delivery (USB-PD) chuẩn, tai nghe có thể hoạt động liên tục trong 3 giờ.',
                ...
                },
                {
                    id: 5,
                    question:
                        'Chuẩn codec âm thanh không dây độ phân giải cao độc quyền của Sony hỗ trợ trên XM5 là gì?',
                    options: [
                        { id: 'A', text: 'aptX HD' },
                        { id: 'B', text: 'LDAC' },
                        { id: 'C', text: 'AAC Plus' },
                    ...
                    correct_option_id: 'B',
                    explanation:
                        'LDAC là công nghệ mã hóa âm thanh độc quyền của Sony, truyền dữ liệu nhiều hơn gấp 3 lần so với Bluetooth SBC thông thường.',
    ...
    },
    {
        ...
        data: {
            ...
            summary:
                'Bộ câu hỏi thú vị về Mô hình ngôn ngữ lớn (LLM), Generative AI và sự phát triển vượt bậc của trí tuệ nhân tạo.',
            questions: [
                {
                    id: 1,
                    ...
                    correct_option_id: 'A',
                    explanation:
                        'Large Language Model (Mô hình ngôn ngữ lớn) là loại mô hình trí tuệ nhân tạo được huấn luyện trên khối lượng dữ liệu văn bản khổng lồ.',
                ...
                },
                {
                    id: 2,
                    question:
                        'Kiến trúc mạng thần kinh nào ra đời năm 2017 tạo nên bước ngoặt bùng nổ cho GenAI ngày nay?',
                    options: [
                    ...
                    correct_option_id: 'C',
                    explanation:
                        'Kiến trúc Transformer giới thiệu bởi Google năm 2017 với cơ chế Attention (Chú ý) đã cách mạng hóa xử lý ngôn ngữ tự nhiên.',
                ...
                },
                {
                    ...
                    correct_option_id: 'B',
                    explanation:
                        'Hallucination (Ảo giác AI) mô tả hiện tượng AI tạo ra thông tin trông có vẻ tự tin và hợp lý nhưng hoàn toàn sai sự thật.',
                ...
                },
                {
                    id: 4,
                    question:
                        "Kỹ thuật 'RAG' giúp cải thiện độ chính xác của AI bằng cách kết nối dữ liệu bên ngoài là viết tắt của gì?",
                    options: [
                    ...
                    correct_option_id: 'A',
                    explanation:
                        'RAG (Retrieval-Augmented Generation) giúp mô hình truy xuất tài liệu nội bộ hoặc dữ liệu mới nhất trước khi tổng hợp câu trả lời.',
    ...
    },
    {
        ...
        data: {
            ...
            summary:
                'Khám phá các bí ẩn kỳ thú về Hệ Mặt Trời, ngôi sao và vận tốc ánh sáng qua bộ trắc nghiệm Kahoot hấp dẫn.',
            questions: [
                {
                    id: 1,
                    ...
                    correct_option_id: 'B',
                    explanation:
                        'Sao Hỏa có màu đỏ do bề mặt chứa lượng lớn sắt oxit (gỉ sắt) tạo nên vẻ ngoài đỏ cam rực rỡ.',
                ...
                },
                {
                    ...
                    correct_option_id: 'A',
                    explanation:
                        'Với khoảng cách xấp xỉ 150 triệu km và tốc độ ánh sáng ~300.000 km/s, ánh sáng mất khoảng 500 giây (~8 phút 20 giây) để tới Trái Đất.',
                ...
                },
                {
                    id: 3,
                    question:
                        'Kính thiên văn không gian hàng đầu thế giới được phóng năm 2021 thay thế cho Hubble có tên là gì?',
                    options: [
                        { id: 'A', text: 'Kepler' },
                    ...
                    correct_option_id: 'B',
                    explanation:
                        'Kính thiên văn James Webb (JWST) quan sát ở dải sóng hồng ngoại, giúp chụp những bức ảnh vũ trụ sâu chưa từng có.',
